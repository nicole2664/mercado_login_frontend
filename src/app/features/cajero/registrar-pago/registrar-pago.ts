...
export class RegistrarPago {
  ...
  seleccionarSocio(dni: string) {
    const mockSocio: Socio = {
      ...
      puestos: ['B-205', 'B-206'],
      deudas: [
        { id: 1, titulo: 'Renta Mensual - Abril 2026', monto: 1250, vencimiento: '10/04/2026', seleccionada: false },
        { id: 2, titulo: 'Mantenimiento y Limpieza', monto: 150, vencimiento: '05/04/2026', seleccionada: false }
      ]
    };
